...
import ImageLogo from "../public/img/etelvina4.png";
  ...
  return (
    <div className="bg-stone-100">
      <div className="relative isolate px-6 pt-1 lg:px-8 ">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 remove-margin">
          ...
          <br />
            ...
            <div className="flex justify-center items-center pt-1">
              <div className="followers_arc_outer items-center followers_arc_start o_circle">
                <div className="followers_arc_inner items-center followers_arc_start i_circle"></div>
              </div>
              <img  id="alien" className=" w-auto " src="./img/etelvina4.png" alt="" />
            </div>
            ...
            <div
              className="flex justify-center items-center pt-1 fala"
              >
                <p className="p-1">...</p>
                  
             </div>
             <button id="mic" className="btn btn-lg input talk"><img className=" w-auto  h-12 w-24 " src="./img/mic.svg" alt="" /> </button>        
              <label
                htmlFor="message"
        ...
        {/* <div
          className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)] bg-transparent"
          aria-hidden="true"
        >
